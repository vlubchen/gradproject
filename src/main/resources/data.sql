...
VALUES (CURRENT_DATE - 2, 1, 1, 10000),
       ...
       (CURRENT_DATE - 2, 2, 5, 10000),
       (CURRENT_DATE - 2, 2, 6, 25000),
       (CURRENT_DATE - 2, 2, 7, 70000),
       (CURRENT_DATE - 2, 2, 8, 2500),
       (CURRENT_DATE - 2, 3, 9, 10000),
       (CURRENT_DATE - 2, 3, 10, 20000),
       (CURRENT_DATE - 2, 3, 11, 60000),
       (CURRENT_DATE - 2, 3, 12, 2500),

       (CURRENT_DATE - 1, 1, 1, 10000),
       (CURRENT_DATE - 1, 1, 2, 40000),
       (CURRENT_DATE - 1, 1, 3, 70000),
       (CURRENT_DATE - 1, 1, 4, 2000),
       (CURRENT_DATE - 1, 2, 5, 10000),
       (CURRENT_DATE - 1, 2, 6, 25000),
       (CURRENT_DATE - 1, 2, 7, 70000),
       (CURRENT_DATE - 1, 2, 8, 2500),
       (CURRENT_DATE - 1, 3, 9, 10000),
       (CURRENT_DATE - 1, 3, 10, 20000),
       (CURRENT_DATE - 1, 3, 11, 60000),
       (CURRENT_DATE - 1, 3, 12, 2500),

       (CURRENT_DATE, 1, 1, 10000),
       (CURRENT_DATE, 1, 2, 40000),
       (CURRENT_DATE, 1, 3, 70000),
       (CURRENT_DATE, 1, 4, 2000),
       (CURRENT_DATE, 2, 5, 10000),
       (CURRENT_DATE, 2, 6, 25000),
       (CURRENT_DATE, 2, 7, 70000),
       (CURRENT_DATE, 2, 8, 2500),
       (CURRENT_DATE, 3, 9, 10000),
       (CURRENT_DATE, 3, 10, 20000),
       (CURRENT_DATE, 3, 11, 60000),
       (CURRENT_DATE, 3, 12, 2500);
